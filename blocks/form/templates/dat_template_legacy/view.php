...
<form enctype="multipart/form-data" class="form-stacked" id="miniSurveyView<?php  echo $bID; ?>" class="miniSurveyView" method="post" action="<?php  echo $formAction ?>">
	...
	<div class="fields">
		...
		<?php  foreach ($questions as $question): ?>
			<div class="<?php echo ($question['required']) ? 'required-field ' : '' ?>form-group field field-<?php  echo $question['type']; ?>">
				<?php
				//ADDING PLACEHOLDER
				$question['input'] = str_replace(' name=', ' placeholder="' . $question['question'] . '" name=', $question['input']);
				...
				if ($question['required']) {
					$question['input'] = str_replace(' name=', ' required="required" name=', $question['input']);
				}
	...
	<?php  if ($captcha): ?>
		<div class="form-group captcha">
			...
			<div class="captcha-image"><?php  $captcha->display(); ?></div>
			<div class="captcha-input"><?php  $captcha->showInput(); ?></div>
		</div>
	<?php  endif; ?>
